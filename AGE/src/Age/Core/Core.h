...
// Commented it out as it's not completely clear if it won't be necessary.
// Seems like we should move further with static library.
// At least for now I can't figure out what to do to the ImGui in order to make it work with shared lib.
