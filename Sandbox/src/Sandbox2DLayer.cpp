...
void Sandbox2DLayer::OnUpdate(AGE::Timestep ts) {
  ...
  AGE::Renderer2D::DrawQuad(
      glm::vec2{0.0f, 0.5f}, glm::vec2{0.4f}, m_CreeperFaceTex, {1.0f, 1.0f, 5.0f, 1.0f}
  );

  AGE::Renderer2D::DrawQuad(
      glm::vec2{0.5f, -0.5f}, glm::vec2{0.4f}, m_CreeperFaceTex
  );

  AGE::Renderer2D::DrawQuad(
      glm::vec2{-0.5f, -0.5f}, glm::vec2{0.4f}, {0.6f, 0.2f, 0.8f, 1.0f}
  );
